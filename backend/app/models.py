...
class User(Base):
    ...
    verification_token: Mapped[str | None] = mapped_column(String(128), nullable=True, unique=True)
    reset_token: Mapped[str | None] = mapped_column(String(128), nullable=True, unique=True)
